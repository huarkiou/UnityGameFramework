...
namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    public class ZipEntry
    {
        ...
        public long DosTime
        {
            ...
            set
            {
                unchecked
                {
                    ...
                    int day = Math.Max(1,
                        Math.Min(DateTime.DaysInMonth((int)year, (int)mon), (int)((value >> 16) & 0x1f)));
                    DateTime = new DateTime((int)year, (int)mon, day, (int)hrs, (int)min, (int)sec,
        ...
        {
            return method == CompressionMethod.Deflated
