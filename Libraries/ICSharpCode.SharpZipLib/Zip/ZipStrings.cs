...
namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    public static class ZipStrings
    {
        ...
        {
            return compatibilityMode ? CompatCodec : StringCodec.Default;
        }
        ...
        {
            return CompatCodec.ZipOutputEncoding.GetString(data, 0, count);
        }
        ...
        {
            return CompatCodec.ZipOutputEncoding.GetString(data);
        }
        ...
        {
            return CompatCodec.ZipEncoding(HasUnicodeFlag(flags)).GetString(data, 0, count);
        }
        ...
        {
            return CompatCodec.ZipEncoding(HasUnicodeFlag(flags)).GetString(data);
        }
    ...
    public class StringCodec
    {
        ...
        {
            return new StringCodec(false, Encoding.GetEncoding(ZipSpecCodePage));
        }
        ...
        {
            return unicode ? UnicodeZipEncoding : LegacyEncoding;
        }
        ...
        {
            return new StringCodec(true, LegacyEncoding)
            {
                ZipArchiveCommentEncoding = ZipArchiveCommentEncoding,
                ZipCryptoEncoding = ZipCryptoEncoding
            };
