...
namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    internal static class ZipFormat
    {
        ...
        internal static long LocateBlockWithSignature(Stream stream, int signature, long endLocation,
        ...
        {
            await stream
                .WriteProcToStreamAsync(
                    s => WriteZip64EndOfCentralDirectory(s, noOfEntries, sizeEntries, centralDirOffset),
        ...
        internal static void WriteZip64EndOfCentralDirectory(Stream stream, long noOfEntries, long sizeEntries,
        ...
        internal static void WriteEndOfCentralDirectory(Stream stream, long noOfEntries, long sizeEntries, long start,
            byte[] comment)
        {
