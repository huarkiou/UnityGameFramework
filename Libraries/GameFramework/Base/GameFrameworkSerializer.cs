...
namespace GameFramework
{
    ...
    public abstract class GameFrameworkSerializer<T>
    {
        ...
        public bool Serialize(Stream stream, T data, byte version)
        {
            ...
            {
                throw new GameFrameworkException(Utility.Text.Format("Serialize callback '{0}' is not exist.",
                    version));
            }
        ...
        public T Deserialize(Stream stream)
        {
            ...
            {
                throw new GameFrameworkException(Utility.Text.Format("Deserialize callback '{0}' is not exist.",
                    version));
            }
