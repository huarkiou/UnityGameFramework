...
namespace ICSharpCode.SharpZipLib.Core
{
    ...
    public static class StreamUtils
    {
        ...
        internal static async Task WriteProcToStreamAsync(this Stream targetStream, MemoryStream bufferStream,
            Action<Stream> writeProc, CancellationToken ct)
        {
        ...
        internal static async Task WriteProcToStreamAsync(this Stream targetStream, Action<Stream> writeProc,
