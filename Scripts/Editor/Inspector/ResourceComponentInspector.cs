...
namespace UnityGameFramework.Editor
{
    ...
    internal sealed class ResourceComponentInspector : GameFrameworkInspector
    {
        ...
        private HelperInfo<LoadResourceAgentHelperBase> m_LoadResourceAgentHelperInfo =
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.BeginDisabledGroup(EditorApplication.isPlaying && isEditorResourceMode);
            {
                ...
                float resourceAutoReleaseInterval = EditorGUILayout.DelayedFloatField("Resource Auto Release Interval",
                ...
                if (m_ResourceModeIndex > 0)
                {
                    ...
                    int generateReadWriteVersionListLength = EditorGUILayout.DelayedIntField(
            ...
            if (EditorApplication.isPlaying && IsPrefabInHierarchy(t.gameObject))
            {
                EditorGUILayout.LabelField("Unload Unused Assets",
                    Utility.Text.Format("{0:F2} / {1:F2}", t.LastUnloadUnusedAssetsOperationElapseSeconds,
                                    ...
                                    try
                                    {
                                        ...
                                        foreach (TaskInfo loadAssetInfo in loadAssetInfos)
                                        {
                                            data[index++] = Utility.Text.Format("{0},{1},{2},{3}",
                                                loadAssetInfo.Description, loadAssetInfo.SerialId,
